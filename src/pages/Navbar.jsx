        ...
        <div >
          <ul className='flex'>
            ...
            (
              <>
                <li>
                  <Togglemenu setIsLogin={setIsLogin}/>
                </li>
              </>
            ):(
              <>
                <li>
                  <Link to='/login' setIsLogin={setIsLogin}  className='text-lg rounded-lg p-2 bg-slate-900 m-2 hover:border px-4 text-stone-100 hover:text-stone-200'>Login</Link>
                </li>
                <li>
